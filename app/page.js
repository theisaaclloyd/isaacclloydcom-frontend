...
export default function Home() {
	return (
		<main className="h-screen flex flex-col">
			...
			<section className="flex h-full items-center justify-center" id="home" >
				<div className="flex flex-col md:flex-row w-full md:items-center mx-auto justify-center flex-container" >

					<div className="flex md:pr-8 justify-center image-container">
						<Image
					...
					<FadeIn className="flex pt-5 flex-col items-center text-center md:text-left justify-center md:items-start gap-0">
