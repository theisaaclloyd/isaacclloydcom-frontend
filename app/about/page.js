	...
	return (
		<main className="h-screen flex flex-col">
			...
			<section className="h-full flex items-left justify-center" id="home" >
				<div className="flex flex-col text-center items-center justify-center gap-5 mx-10 md:mx-60">
					<div className="text-5xl underline underline-offset-8 text-test3">About me</div>
